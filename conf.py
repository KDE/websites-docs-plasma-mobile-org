...
# ones.
extensions = ['sphinxcontrib.doxylink', 'aether_sphinx']
...
htmlhelp_basename = 'PlasmaMobiledoc'
...
latex_documents = [
    (master_doc, 'PlasmaMobile.tex', 'Plasma Mobile Documentation',
     'KDE Community', 'manual'),
]
...
man_pages = [
    (master_doc, 'plasmamobile', 'Plasma Mobile Documentation',
     [author], 1)
]
...
doxylink = {
        ...
        'kcontactsapi': ('KContacts.tags', 'https://api.kde.org/frameworks/kcontacts/html/'),
